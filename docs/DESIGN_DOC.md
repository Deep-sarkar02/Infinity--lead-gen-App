...
**Logo:** Official asset at `client/public/logo-white.png` — Infinity Learn wordmark, chevron, "BY SRI CHAITANYA". Login uses black card; sidebar uses white-on-blue blend.
