...
| Asset | Path | Usage |
|-------|------|-------|
| **Official logo (white)** | `frontend/public/logo-white.png` | Sidebar (blue bg), login (black card) |
...
> Full scale in `frontend/src/styles/tokens.css`. Sampled from `assets/infinity-learn-color-palette.png`.
